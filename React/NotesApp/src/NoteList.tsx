...
import { Row, Button, Col, Stack, Form, Card, Badge, Modal } from "react-bootstrap";
...
function NoteCard({id, title, tags}: SimplifiedNote) {
 return (
    <Card as={Link} to={`/${id}`} className={`h-100 text-reset bg-light text-decoration-none ${styles.card}`}>
        <Card.Body>
            <Stack gap={2} direction="horizontal" 
